...
function parseEmailToTask(email) {
    ...
    console.log('Parsed email task:', {
        originalSubject: (_a = email.subject) === null || _a === void 0 ? void 0 : _a.substring(0, 50),
        cleanSubject: cleanSubject.substring(0, 50),
        descriptionLength: description.length,
        importance,
        dueDate: dueDate === null || dueDate === void 0 ? void 0 : dueDate.toISOString(),
...
exports.processEmailTask = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        if (!Array.isArray(parsedBody) && parsedBody && typeof parsedBody === 'object') {
            ...
            if (numericKeys.length > 0 && numericKeys.length >= Math.floor(objectKeys.length * 0.5)) {
                ...
                try {
                            ...
                            try {
                                ...
                                if (parsed && typeof parsed === 'object') {
                                    ...
                                    if (parsed.message && parsed.message.headers && typeof parsed.message.headers === 'object') {
                                        const hdrs = parsed.message.headers;
                                        from = typeof hdrs.from === 'string' ? hdrs.from : from;
                                        to = typeof hdrs.to === 'string' ? hdrs.to : to;
                                        subject = typeof hdrs.subject === 'string' ? hdrs.subject : subject;
                    ...
                    console.log('Array-like extraction results:', { hasFrom: !!from, hasTo: !!to, hasSubject: !!subject, textLength: text === null || text === void 0 ? void 0 : text.length, htmlLength: html === null || html === void 0 ? void 0 : html.length });
                }
                catch (e) {
        ...
        console.log('Extracted and sanitized email data:', {
            ...
            textLength: (sanitizedText === null || sanitizedText === void 0 ? void 0 : sanitizedText.length) || 0,
            htmlLength: (sanitizedHtml === null || sanitizedHtml === void 0 ? void 0 : sanitizedHtml.length) || 0,
            textPreview: sanitizedText === null || sanitizedText === void 0 ? void 0 : sanitizedText.substring(0, 50),
            isForwarded: (sanitizedSubject === null || sanitizedSubject === void 0 ? void 0 : sanitizedSubject.toLowerCase().includes('fwd')) || (sanitizedSubject === null || sanitizedSubject === void 0 ? void 0 : sanitizedSubject.toLowerCase().includes('forward'))
        });
        ...
        console.log('Email task parsed:', {
            ...
            dueDate: (_d = emailTask.dueDate) === null || _d === void 0 ? void 0 : _d.toISOString()
        });
